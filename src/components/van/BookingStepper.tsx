...
interface BookingStepperProps {
  ...
  basketAmount?: number; // CHF total shown in mobile header
}

export default function BookingStepper({ currentStep, basketAmount }: BookingStepperProps) {
  ...
  return (
    <>
      ...
      <div className="md:hidden sticky top-0 z-30">
        ...
        {/* Dark sub-header with step title + back */}
