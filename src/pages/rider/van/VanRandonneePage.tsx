...
const SPOTS = [
  { name: 'Salève', region: 'Haute-Savoie', duration: '0h30', price: 'dès 25 CHF', tag: 'Frontalier' },
  { name: 'Chamonix · Mer de Glace', region: 'Haute-Savoie', duration: '1h15', price: 'dès 45 CHF', tag: 'Premium' },
  { name: 'Aiguilles Rouges', region: 'Haute-Savoie', duration: '1h20', price: 'dès 48 CHF', tag: 'Frontalier' },
  { name: 'Dents du Midi', region: 'Valais', duration: '1h45', price: 'dès 60 CHF', tag: 'Famille' },
  { name: 'Lac de Tanay', region: 'Valais', duration: '1h30', price: 'dès 55 CHF', tag: 'Famille' },
  { name: 'Creux du Van', region: 'Neuchâtel', duration: '1h45', price: 'dès 65 CHF', tag: 'Premium' },
  { name: 'Rochers de Naye', region: 'Vaud', duration: '1h15', price: 'dès 45 CHF', tag: 'Famille' },
  { name: 'Col de la Forclaz', region: 'Haute-Savoie', duration: '1h00', price: 'dès 38 CHF', tag: 'Frontalier' },
];

const SLOTS = ['05:30', '06:00', '06:30', '07:00', '07:30', '08:00', '16:00', '17:00', '18:00', '19:00'];

const VanRandonneePage: React.FC = () => {
    ...
    <div className="min-h-screen bg-white" style={{ background: '#F8F7F2', paddingBottom: 96 }}>
      ...
      <div style={{ background: '#0A0A0A', color: '#fff', padding: '40px 5%' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: GOLD, letterSpacing: '2px', textTransform: 'uppercase', marginBottom: 8 }}>
            <Mountain size={12} style={{ display: 'inline', marginRight: 6, verticalAlign: 'middle' }} />
            Saison été · Genève → Sentiers
          </div>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 700, margin: '0 0 12px', lineHeight: 1.15 }}>
            Aux sentiers en van, sans stress et sans voiture
          </h1>
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.7)', margin: 0, lineHeight: 1.6 }}>
            Sacs et bâtons inclus, départs matinaux dès 5h30, retour en fin de journée.
            Tous les massifs CH et FR au départ de Genève.
          </p>
        </div>
      </div>
      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 5%' }}>
        ...
        <section style={{ background: '#fff', borderRadius: 12, padding: 20, border: '1px solid #E0DDD5', marginBottom: 16, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 14 }}>
          {[
            { icon: '🥾', label: 'Chaussures', price: 'Inclus' },
            { icon: '🎒', label: 'Sac à dos', price: 'Inclus' },
            { icon: '🧗', label: 'Bâtons de marche', price: 'Inclus' },
            { icon: '⛺', label: 'Tente / matériel bivouac', price: '+15 CHF' },
          ].map(item => (
        ...
        <section style={{ background: '#fff', borderRadius: 12, padding: 24, border: '1px solid #E0DDD5', marginBottom: 16 }}>
          <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0A0A0A', margin: '0 0 14px' }}>Spots desservis</h2>
        ...
        {/* Créneaux */}
        <section style={{ background: '#fff', borderRadius: 12, padding: 24, border: '1px solid #E0DDD5', marginBottom: 16 }}>
          <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0A0A0A', margin: '0 0 6px' }}>Créneaux randonnée (week-ends & vacances)</h2>
          <p style={{ fontSize: 12, color: '#888780', margin: '0 0 14px' }}>Départs tôt le matin, retours en fin de journée — adaptés aux dénivelés et à la lumière du jour.</p>
        ...
        <section style={{ background: '#fff', borderRadius: 12, padding: 24, border: '1px solid #E0DDD5', marginBottom: 16 }}>
          ...
          {[
            ...
            'Soute spacieuse pour sacs à dos et matériel',
            'Eau minérale et collation à bord',
        ...
        <section style={{ background: '#0A0A0A', color: '#fff', borderRadius: 12, padding: 24, textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, marginBottom: 6 }}>
            Réservez votre van vers les sentiers
          </div>
...
export default VanRandonneePage;
