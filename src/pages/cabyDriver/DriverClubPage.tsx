...
const MOCK_LEADERBOARD: LeaderboardEntry[] = [
  { rank: 1, driverName: 'Moussa Diallo', initials: 'MD', avatarColor: AVATAR_COLORS[0], driverAvatar: undefined as unknown as string, driverCity: 'Genève', score: 94, rating: 4.97, rides: 185, isWinner: true },
  { rank: 2, driverName: 'Alexandre Koné', initials: 'AK', avatarColor: AVATAR_COLORS[1], driverAvatar: undefined as unknown as string, driverCity: 'Carouge', score: 91, rating: 4.93, rides: 172 },
  { rank: 3, driverName: 'Youssef Benali', initials: 'YB', avatarColor: AVATAR_COLORS[2], driverAvatar: undefined as unknown as string, driverCity: 'Vernier', score: 88, rating: 4.90, rides: 158 },
  { rank: 4, driverName: 'Jean-Paul Müller', initials: 'JM', avatarColor: AVATAR_COLORS[3], driverAvatar: undefined as unknown as string, driverCity: 'Lancy', score: 85, rating: 4.87, rides: 127, isCurrentUser: true },
  { rank: 5, driverName: 'Pierre Lugrin', initials: 'PL', avatarColor: AVATAR_COLORS[4], driverAvatar: undefined as unknown as string, driverCity: 'Meyrin', score: 82, rating: 4.85, rides: 145 },
  { rank: 6, driverName: 'David Rouiller', initials: 'DR', avatarColor: AVATAR_COLORS[5], driverAvatar: undefined as unknown as string, driverCity: 'Onex', score: 80, rating: 4.82, rides: 130 },
  { rank: 7, driverName: 'Samuel Tettamanti', initials: 'ST', avatarColor: AVATAR_COLORS[6], driverAvatar: undefined as unknown as string, driverCity: 'Thônex', score: 78, rating: 4.80, rides: 118 },
  { rank: 8, driverName: 'Marc Auberson', initials: 'MA', avatarColor: AVATAR_COLORS[7], driverAvatar: undefined as unknown as string, driverCity: 'Chêne-Bourg', score: 75, rating: 4.78, rides: 110 },
  { rank: 9, driverName: 'Nicolas Favre', initials: 'NF', avatarColor: AVATAR_COLORS[8], driverAvatar: undefined as unknown as string, driverCity: 'Plan-les-Ouates', score: 72, rating: 4.75, rides: 105 },
  { rank: 10, driverName: 'Karim Sadki', initials: 'KS', avatarColor: AVATAR_COLORS[9], driverAvatar: undefined as unknown as string, driverCity: 'Bernex', score: 70, rating: 4.72, rides: 95 },
];
