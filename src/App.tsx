...
import VanRdvPage from "./pages/rider/VanRdvPage";
...
import HelpCenterPage from "./pages/rider/help/HelpCenterPage";
import HelpArticlePage from "./pages/rider/help/HelpArticlePage";
import TrafficStatusPage from "./pages/rider/help/TrafficStatusPage";
        ...
        <RideProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/caby/van/rdv" element={<VanRdvPage />} />
              ...
              <Route path="/caby/help" element={<HelpCenterPage />} />
              <Route path="/caby/help/contact" element={<ContactPage />} />
              <Route path="/caby/help/trafic" element={<TrafficStatusPage />} />
              <Route path="/caby/help/article/:slug" element={<HelpArticlePage />} />
